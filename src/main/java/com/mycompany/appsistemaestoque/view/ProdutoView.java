...
public class ProdutoView extends javax.swing.JInternalFrame {
    ...
    public ProdutoView() {
        ...
        carregarComboTipos();//função para preencher o combo box com dados do banco
    }

    private void carregarComboTipos() {
        //abre conexão com o banco e executa um select que retorna o todos os "tipos"
        List<TipoProduto> tipos = new TipoProdutoDAO().listarTipos();
        for (TipoProduto t : tipos) {//percorre a lista e adiciona o objeto interio no combo
            jCBTipo.addItem(t);
        }
    }
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        ...
        descricao = jTFDescricao.getText();//coleta do campo de texto para a variável
        ...
        Produto produtoCadastrado = new Produto(null, descricao, valorUnitario, tipoId, quantidade);//criar nova instância para produto
        
        new ProdutoDAO().cadastrarProduto(produtoCadastrado);//salva no banco

        JOptionPane.showMessageDialog(rootPane, "Registro Inserido!");//mostra mensagem de sucesso
        //limpa os campos
